...
<html lang="en">
  ...
  <body>
    <nav class="navbar fixed-top bg-body-tertiary shadow-sm">
      <div class="container-fluid p-3">
        <a class="navbar-brand" href="#">
          <img src="../assets/logoNavbar.png" alt="logo" width="100px">
        </a>
    ...
    <div class="mt-5 p-4">
      ...
      <h1 class="mt-5 fw-bold">Happy Working - <span class="fs-4 text-secondary"> <?php echo $day. " ". $dayOfMonth." ". " ". $month. " ". $year; ?> </span></h1>
    
      <div class="alert alert-success" role="alert">Selamat Datang Admin - <span class="fw-bold text-capitalize"><?php echo $_SESSION['admin']['nama_admin']; ?></span> di Dashboard E-Perpus</div>
    ...
    <footer class="shadow-lg bg-subtle p-3">
      ...
      <p class="mt-2">Created by <span class="text-primary">Messi</span> © 2024</p>
