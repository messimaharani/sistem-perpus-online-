...
<html lang="en">
  ...
  <div class="container-fluid">
    <img src="assets/logoNavbar.png" alt="logo" width="130px">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary">E-</span>Perpus</h2>
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">E-Perpus</span> Membawa Anda ke Dunia Buku Digital."</p>
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">Messi Arita Maharani</div>
        <div class="card-body">
          <h5 class="card-title">Student At SMKN 8 Semarang</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark"> 
      ...
      <div class="row p-3">
        <div class="col mt-3">
          ...
          <p class="text-secondary fs-6">JL Pandanaran 2, No.12 Semarang</p>
        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width ❤️ <a href="" class="text-decoration-none">Messi</a>  2023</p>
        </div>
      </div>
    </footer>
